...
primary_votes <- ggplot(polling1922, aes(x=as.Date(last_date, '%d %b %Y'))) +
  theme_bw() +
  geom_point(aes(y=pv_lnp), colour="blue4", size=2.5, alpha = 3/10) +
  geom_smooth(aes(y=pv_lnp, colour="LNP"), span = spansize, se = FALSE) +
  geom_point(aes(y=pv_alp), colour="red3", size=2.5, alpha = 3/10) +
  geom_smooth(aes(y=pv_alp, colour="ALP"), span = spansize, se = FALSE) +
  geom_point(aes(y=pv_grn), colour="green4", size=2.5, alpha = 3/10) +
  geom_smooth(aes(y=pv_grn, colour="GRN"), span = spansize, se = FALSE) +
  geom_point(aes(y=pv_onp), colour="orange3", size=2.5, alpha = 5/10) +
  geom_smooth(aes(y=pv_onp, colour="ONP"), span = spansize, se = FALSE) +
  geom_point(aes(y=pv_uap), colour="yellow3", size=2.5, alpha = 5/10) +
  geom_smooth(aes(y=pv_uap, colour="UAP"), span = spansize, se = FALSE) +
  geom_point(aes(y=pv_oth), colour="gray60", size=2.5, alpha = 3/10) +
...
tpp <- ggplot(polling1922, aes(x=as.Date(last_date, '%d %b %Y'))) +
  theme_bw() +
  geom_point(aes(y=tpp_lnp), colour="blue4", size=2.5, alpha = 3/10) +
  geom_smooth(aes(y=tpp_lnp, colour="LNP"), span = spansize, se = FALSE) +
  geom_point(aes(y=tpp_alp), colour="red3", size=2.5, alpha = 3/10) +
